...
ksemillas  <- c(311203, 120929, 181213, 912031, 201809) #reemplazar por las propias semillas
...
#hiperparametros_OB <- read.delim('./exp/HT3210/HT321_3.txt')

paramD  <- list( "cp"=         -0.117406808,  #complejidad minima
                 "minsplit"=   1182,  #minima cantidad de registros en un nodo para hacer el split
...
ganD  <- ArbolesMontecarlo( ksemillas, paramD )
#imprimo la media de las ganancias
cat( mean(ganA), mean(ganB), mean(ganC), mean(ganD), "\n" )

...
ksemilla_azar  <- c(311203, 120929, 181213, 912031, 201809)
...
hs  <- makeParamSet(
          ...
          makeIntegerParam("minsplit" , lower=   1,   upper= 5000 ),
          makeIntegerParam("minbucket", lower=   100,   upper= 600 ),
          makeIntegerParam("maxdepth" , lower=   3,  upper=   20),  #la letra L al final significa ENTERO
...
dataset  <- fread("./datasets/competencia1_2022.csv")   #donde entreno     #CAMBIAR PR DATASET FE RANKEADO
